...
def Portfolio(P0T, r_t, lambd, eta):
    ...
    value = (
        ...
        + HW_SwapPrice(
            OptionTypeSwap.PAYER, 500000, 0.01, 0.0, 0.0, 10, 20, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.RECEIVER, 25000, 0.02, 0.0, 0.0, 30, 60, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.PAYER, 74000, 0.005, 0.0, 0.0, 5, 10, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.RECEIVER,
            254000,
        ...
        + HW_SwapPrice(
            OptionTypeSwap.RECEIVER, 854000, 0.01, 0.0, 0.0, 7, 20, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.PAYER, 900000, 0.045, 0.0, 0.0, 10, 20, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.PAYER, 400000, 0.02, 0.0, 0.0, 10, 20, r_t, P0T, lambd, eta
        )
        + HW_SwapPrice(
            OptionTypeSwap.RECEIVER,
            1000000,
        ...
        + HW_SwapPrice(
            OptionTypeSwap.PAYER, 115000, 0.06, 0.0, 0.0, 9, 10, r_t, P0T, lambd, eta
        )
    )
